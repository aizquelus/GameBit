...
const Cart = () => {
  ...
  return (
    <Center minH='70vh' flexDirection="column" p="5%" justifyContent={cart.length > 0 ? "flex-start" : "center"} alignItems={cart.length > 0 ? "flex-start" : "center"}>
          ...
          {cart.length > 0 && <Flex display="flex" alignItems="center" w="100%" ><Checkout /></Flex>}
      
      <Flex alignItems={cart.length > 0 ? "flex-end" : "center"} flexDirection={cart.length > 0 ? "row" : "column"}>
          {
